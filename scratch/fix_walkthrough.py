...
if os.path.exists(wt_path):
    print("Reading walkthrough.md with ignore errors...")
    # read with errors='ignore' or 'replace' to bypass decoding errors
    with open(wt_path, "r", encoding="utf-8", errors="ignore") as f:
        content = f.read()
    
    # We will search for "## Kết quả Kiểm chứng" and replace everything after it with a clean summary
...
- **Tài liệu Độc quyền Topal (Word & Excel)**:
  ...
  - Kết quả: Hoàn thành xuất sắc. Sinh ra tệp Word [ThuVien_HeCuaNhom_Topal.docx](file:///d:/Sao%20V%C3%A0ng/Website-SaoVang/BaoCao_ThuVien_CuaNhom/ThuVien_HeCuaNhom_Topal.docx) mô tả chi tiết các dòng Prima, Slima, XFAD và tệp Excel [Catalogue_HeCuaNhom_Topal.xlsx](file:///d:/Sao%20V%C3%A0ng/Website-SaoVang/BaoCao_ThuVien_CuaNhom/Catalogue_HeCuaNhom_Topal.xlsx) trình bày danh mục 8 hệ sản phẩm chuẩn.
"""
