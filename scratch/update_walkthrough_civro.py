...
if os.path.exists(wt_path):
    print("Reading walkthrough.md to append Civro...")
    with open(wt_path, "r", encoding="utf-8", errors="ignore") as f:
        content = f.read()
    
    # 1. Update outputs list (we will replace the Owin lines to include Civro as well)
    # Let's search for the Owin lines and append Civro
    search_str = """   - Word Độc quyền Owin (.docx): [ThuVien_HeCuaNhom_Owin.docx](file:///d:/Sao%20V%C3%A0ng/Website-SaoVang/BaoCao_ThuVien_CuaNhom/ThuVien_HeCuaNhom_Owin.docx)
   - Excel Độc quyền Owin (.xlsx): [Catalogue_HeCuaNhom_Owin.xlsx](file:///d:/Sao%20V%C3%A0ng/Website-SaoVang/BaoCao_ThuVien_CuaNhom/Catalogue_HeCuaNhom_Owin.xlsx)"""
    ...
    replace_str = """   - Word Độc quyền Owin (.docx): [ThuVien_HeCuaNhom_Owin.docx](file:///d:/Sao%20V%C3%A0ng/Website-SaoVang/BaoCao_ThuVien_CuaNhom/ThuVien_HeCuaNhom_Owin.docx)
   - Excel Độc quyền Owin (.xlsx): [Catalogue_HeCuaNhom_Owin.xlsx](file:///d:/Sao%20V%C3%A0ng/Website-SaoVang/BaoCao_ThuVien_CuaNhom/Catalogue_HeCuaNhom_Owin.xlsx)
   - Word Độc quyền Civro (.docx): [ThuVien_HeCuaNhom_Civro.docx](file:///d:/Sao%20V%C3%A0ng/Website-SaoVang/BaoCao_ThuVien_CuaNhom/ThuVien_HeCuaNhom_Civro.docx)
   - Excel Độc quyền Civro (.xlsx): [Catalogue_HeCuaNhom_Civro.xlsx](file:///d:/Sao%20V%C3%A0ng/Website-SaoVang/BaoCao_ThuVien_CuaNhom/Catalogue_HeCuaNhom_Civro.xlsx)"""
    ...
    if search_str in content:
        ...
        print("Updated output files list section with Civro.")
...
- **Tài liệu Độc quyền Civro (Word & Excel)**:
  ...
  - Kết quả: Hoàn thành xuất sắc. Sinh ra tệp Word [ThuVien_HeCuaNhom_Civro.docx](file:///d:/Sao%20V%C3%A0ng/Website-SaoVang/BaoCao_ThuVien_CuaNhom/ThuVien_HeCuaNhom_Civro.docx) mô tả chi tiết cầu cách nhiệt Technoform BAUTEC cách âm tới 45dB, lớp phủ MED độc quyền Đức, và tệp Excel [Catalogue_HeCuaNhom_Civro.xlsx](file:///d:/Sao%20V%C3%A0ng/Website-SaoVang/BaoCao_ThuVien_CuaNhom/Catalogue_HeCuaNhom_Civro.xlsx) phân loại 8 hệ trượt nâng CSD80/130 tối giản.
"""
        with open(wt_path, "w", encoding="utf-8") as f:
            f.write(header_part + new_validation_part)
        print("Successfully updated walkthrough.md validation section with Civro")
    else:
